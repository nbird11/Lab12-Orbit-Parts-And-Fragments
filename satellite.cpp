 ...
 *****************************************************************************/
Satellite::Satellite(const Position& pos, const Velocity& velocity, 
   const Angle& direction, double angularVelocity, double radius) : dead(false)
{
...
{
   return GRAVITY_SEA * (RADIUS_EARTH / (RADIUS_EARTH + h)) * 
      (RADIUS_EARTH / (RADIUS_EARTH + h));
}
